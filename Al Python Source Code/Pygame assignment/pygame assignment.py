...
# In a time not so far in the future, the prophecy of the red moon has become true, the end times are quickly approaching and the inhabitants of the house have blocked all possible entrances but nothing can save them from the divine PORTALS OF HELL!!!
...
DOOR = (100,70,45)
STREAK=  (100,120,205)
KNOB = (135,100,255) hello igofffhfodfogfhdp\
MOON = (200, 70, 105)
STAR = (255,255,153)
WOOD = (236,167,117)
DARKRED = (139,0,0)
